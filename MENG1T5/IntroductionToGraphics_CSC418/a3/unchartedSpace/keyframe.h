...
public:
	...
	/*enum { ROOT_TRANSLATE_X, ROOT_TRANSLATE_Y, ROOT_TRANSLATE_Z,
		   ...
		   BEAK,
		   R_ELBOW_PITCH,    R_ELBOW_YAW,      R_ELBOW_ROLL,
		   L_ELBOW_PITCH,    L_ELBOW_YAW,      L_ELBOW_ROLL,
		   R_KNEE_PITCH,     R_KNEE_YAW,       R_KNEE_ROLL,
		   L_KNEE_PITCH,     L_KNEE_YAW,       L_KNEE_ROLL,
		   R_FOOT_PITCH,     R_FOOT_YAW,       R_FOOT_ROLL,
		   L_FOOT_PITCH,     L_FOOT_YAW,       L_FOOT_ROLL,
		   LIGHTANGLE,*/
		   //the new keyframe list si below
	enum { ROOT_TRANSLATE_X, ROOT_TRANSLATE_Y, ROOT_TRANSLATE_Z,
		   ROOT_ROTATE_X,    ROOT_ROTATE_Y,    ROOT_ROTATE_Z,
		   HEAD_PITCH,       HEAD_YAW,         HEAD_ROLL,
		   BEAK,
	...
	void  setDOFAdd(int eDOF, float val) { jointDOFS[eDOF] += val;  }
