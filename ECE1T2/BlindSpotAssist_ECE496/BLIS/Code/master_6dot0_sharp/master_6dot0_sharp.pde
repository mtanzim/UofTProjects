...
int ss_index=0;
const int SS_CHECKER_SIZE=9; //AMOUNT OF LAST SPEEDS TO CHECK, MUST BE LESS THAN NUM_SPEED_READINGS
...
//    led_value = 254 - average_distance;        // this means the smaller the distance the brighterthe LED.
//  }
//  else{
//    led_value=0;
//  }
