...
#define ERR_TABLE_NOT_FOUND 3	///< The table does not exist.
#define ERR_KEY_NOT_FOUND 4	///< The key does not exist.
#define ERR_UNKNOWN 5		///< Any other error.
 ...
 * ERR_KEY_NOT_FOUND, or ERR_UNKNOWN.
 *
 ...
 * ERR_KEY_NOT_FOUND, or ERR_UNKNOWN.
 *
 * This function must be implemented for the second milestone.
 *
