...
public class control_GUI_fixed extends PApplet {
...
int fillVal1 = color(fill_off);
int fillVal2 = color(fill_off);
int fillVal3 = color(fill_off);
int fillVal4 = color(fill_off);

int fillVal_a = color(fill_off);
int fillVal_s = color(fill_off);
...
public void get_serial_data () {
            ...
            while (myPort.available() > 0) {
              ...
              if (myString != null) {
                speed = PApplet.parseFloat(myString);
                //println(myString);
              }
            }
...
public void keyTyped() { 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "control_GUI_fixed" });
  }
}
